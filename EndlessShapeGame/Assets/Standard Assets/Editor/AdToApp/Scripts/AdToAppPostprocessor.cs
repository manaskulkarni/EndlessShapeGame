...
namespace UnityEngine.Advertisements
{
  ...
  public static class AdToAppPostprocessor
  {
    ...
    private static void ProcessXCodeProject (string path)
    {
      ...
      string modsPath = System.IO.Path.Combine (path, "AdToApp");
    ...
    {
      string modPath = System.IO.Path.Combine (path, "AdToApp");
...
*/
					DirectoryInfo dir = new DirectoryInfo("./assets/WebPlayerTemplates/AdToApp");
					string baseWPTpath = "../../WebPlayerTemplates/AdToApp/";
					...
					foreach (DirectoryInfo d in dir.GetDirectories())
					{
						if (d.Name.StartsWith(".") || 
						    d.Name.ToLower().EndsWith(".meta"))
						{
							continue;
						}

						dependencyList.Add(baseWPTpath + d.Name);

						//logString += baseWPTpath + d.Name;
					}

					foreach (FileInfo f in dir.GetFiles())
					{
						if (f.Name.StartsWith(".") || 
						    f.Name.ToLower().EndsWith(".meta"))
						{
							continue;
						}
						
						dependencyList.Add(baseWPTpath + f.Name);
						
						//logString += baseWPTpath + f.Name;
					}

					//throw new DirectoryNotFoundException ("Final directory list:" + logString);

					/*
	  dependencyList.Add ("../../WebPlayerTemplates/StartApp.bundle");
	  dependencyList.Add ("../../WebPlayerTemplates/MoPub.bundle");
	  dependencyList.Add ("../../WebPlayerTemplates/UnityAds.bundle");
					
	  dependencyList.Add ("../../WebPlayerTemplates/__vungle.db");
	  dependencyList.Add ("../../WebPlayerTemplates/vg_close.png");
	  dependencyList.Add ("../../WebPlayerTemplates/vg_cta.png");
	  dependencyList.Add ("../../WebPlayerTemplates/vg_mute_off.png");
	  dependencyList.Add ("../../WebPlayerTemplates/vg_mute_on.png");
	  dependencyList.Add ("../../WebPlayerTemplates/vg_timer.png");
					    */                
							/*
...
*/
      ...
      headerpaths.Add (copyDependencies ? "$(SRCROOT)/AdToApp" : MacPath (pluginsPath));

      List<string> folders = new List<string> ();
      List<string> excludes = new List<string> ();
	  List<string> otherlinkerflags = new List<string> ();
	  otherlinkerflags.Add ("-ObjC");
	  //otherlinkerflags.Add ("-weak_framework WebKit.framework");

      mod.Add ("group", "AdToApp");
	  ...
	  mod.Add ("otherlinkerflags", otherlinkerflags);

      string jsonMod = MiniJSON.Json.Serialize (mod);

      string file = System.IO.Path.Combine (modPath, "AdToAppXCode.projmods");
