...
(function() {
	...
	var mraid_helper = window.mraid_helper = {};
	...
	function callNative(command, scheme) {
		scheme = scheme || "mraid";
		var iframe = document.createElement("IFRAME");
		iframe.setAttribute("src", scheme + "://" + command);
		document.documentElement.appendChild(iframe);
		iframe.parentNode.removeChild(iframe);
		iframe = null;
	};
	mraid_helper.callNative = callNative;
	...
	mraid_helper.fireEvent = fireEvent;
