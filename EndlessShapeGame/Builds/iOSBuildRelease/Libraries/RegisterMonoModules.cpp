...
extern "C"
{
	...
	const char*			UnityIPhoneRuntimeVersion = "5.2.2f1";
#if !defined(__arm64__)
...
#define DLL_EXPORT __declspec(dllexport)
	...
	extern gpointer*	mono_aot_module_IFacebook_info; // IFacebook.dll
	...
	extern gpointer*	mono_aot_module_TouchScript_info; // TouchScript.dll
	...
	DECL_USER_FUNC(AdToApp_start_platform);
	DECL_USER_FUNC(AdToApp_setUnityCallbackTargetName_platform);
	DECL_USER_FUNC(AdToApp_isInterstitialDisplayed_platform);
	DECL_USER_FUNC(AdToApp_hasInterstitial_platform);
	DECL_USER_FUNC(AdToApp_removeAllBanners_platform);
	DECL_USER_FUNC(AdToApp_showBannerAtPosition_platform);
	DECL_USER_FUNC(AdToApp_showBanner_platform);
	DECL_USER_FUNC(AdToApp_setBannerRefreshInterval_platform);
	DECL_USER_FUNC(AdToApp_setLogLevel_platform);
	DECL_USER_FUNC(AdToApp_showInterstitial_platform);
	DECL_USER_FUNC(AdToApp_loadNextBanner_platform);
	DECL_USER_FUNC(_ISNsubscribe);
	DECL_USER_FUNC(_ISN_RedirectToAppStoreRatingPage);
	DECL_USER_FUNC(_ISN_ShowPreloader);
	DECL_USER_FUNC(_ISN_HidePreloader);
	DECL_USER_FUNC(_ISN_SetApplicationBagesNumber);
	DECL_USER_FUNC(_ISN_GetLocale);
	DECL_USER_FUNC(_ISN_IsGuidedAccessEnabled);
	DECL_USER_FUNC(_ISN_RequestGuidedAccessSession);
	DECL_USER_FUNC(_initGameCenter);
	DECL_USER_FUNC(_showLeaderboard);
	DECL_USER_FUNC(_reportScore);
	DECL_USER_FUNC(_showLeaderboards);
	DECL_USER_FUNC(_ISN_loadLeaderboardInfo);
	DECL_USER_FUNC(_ISN_loadLeaderboardScore);
	DECL_USER_FUNC(_showAchievements);
	DECL_USER_FUNC(_resetAchievements);
	DECL_USER_FUNC(_submitAchievement);
	DECL_USER_FUNC(_ISN_issueLeaderboardChallenge);
	DECL_USER_FUNC(_ISN_issueLeaderboardChallengeWithFriendsPicker);
	DECL_USER_FUNC(_ISN_issueAchievementChallenge);
	DECL_USER_FUNC(_ISN_issueAchievementChallengeWithFriendsPicker);
	DECL_USER_FUNC(_ISN_RetrieveFriends);
	DECL_USER_FUNC(_ISN_loadGKPlayerData);
	DECL_USER_FUNC(_ISN_loadGKPlayerPhoto);
	DECL_USER_FUNC(_ISN_getSignature);
	DECL_USER_FUNC(_ISN_loadLeaderboardSetInfo);
	DECL_USER_FUNC(_ISN_loadLeaderboardsForSet);
	DECL_USER_FUNC(_ISN_ShowNotificationBanner);
	DECL_USER_FUNC(_ISN_GK_IsUnderage);
	DECL_USER_FUNC(_ISN_RTM_FindMatch);
	DECL_USER_FUNC(_ISN_RTM_FindMatchWithNativeUI);
	DECL_USER_FUNC(_ISN_RTM_SetPlayerGroup);
	DECL_USER_FUNC(_ISN_RTM_SetPlayerAttributes);
	DECL_USER_FUNC(ISN_RTM_StartMatchWithInviteID);
	DECL_USER_FUNC(ISN_RTM_CancelPendingInviteToPlayerWithId);
	DECL_USER_FUNC(ISN_RTM_CancelMatchSeartch);
	DECL_USER_FUNC(ISN_RTM_FinishMatchmaking);
	DECL_USER_FUNC(ISN_RTM_QueryActivity);
	DECL_USER_FUNC(ISN_RTM_QueryPlayerGroupActivity);
	DECL_USER_FUNC(ISN_RTM_StartBrowsingForNearbyPlayers);
	DECL_USER_FUNC(ISN_RTM_StopBrowsingForNearbyPlayers);
	DECL_USER_FUNC(ISN_RTM_Rematch);
	DECL_USER_FUNC(ISN_RTM_Disconnect);
	DECL_USER_FUNC(ISN_RTM_SendData);
	DECL_USER_FUNC(ISN_RTM_SendDataToAll);
	DECL_USER_FUNC(_ISN_TBM_LoadMatchesInfo);
	DECL_USER_FUNC(_ISN_TBM_LoadMatch);
	DECL_USER_FUNC(_ISN_TBM_FindMatch);
	DECL_USER_FUNC(_ISN_TBM_FindMatchWithNativeUI);
	DECL_USER_FUNC(_ISN_TBM_SaveCurrentTurn);
	DECL_USER_FUNC(_ISN_TBM_SetPlayerGroup);
	DECL_USER_FUNC(_ISN_TBM_SetPlayerAttributes);
	DECL_USER_FUNC(_ISN_TBM_EndTurn);
	DECL_USER_FUNC(_ISN_TBM_QuitInTurn);
	DECL_USER_FUNC(_ISN_TBM_QuitOutOfTurn);
	DECL_USER_FUNC(_ISN_TBM_UpdateParticipantOutcome);
	DECL_USER_FUNC(_ISN_TBM_EndMatch);
	DECL_USER_FUNC(_ISN_TBM_Rematch);
	DECL_USER_FUNC(_ISN_TBM_RemoveMatch);
	DECL_USER_FUNC(_loadStore);
	DECL_USER_FUNC(_restorePurchases);
	DECL_USER_FUNC(_buyProduct);
	DECL_USER_FUNC(_ISN_InAppSettingState);
	DECL_USER_FUNC(_verifyLastPurchase);
	DECL_USER_FUNC(_createProductView);
	DECL_USER_FUNC(_showProductView);
	DECL_USER_FUNC(_ISN_ScheduleNotification);
	DECL_USER_FUNC(_ISN_CancelNotifications);
	DECL_USER_FUNC(_ISN_RequestNotificationPermissions);
	DECL_USER_FUNC(_ISN_CancelNotificationById);
	DECL_USER_FUNC(_ISN_ApplicationIconBadgeNumber);
	DECL_USER_FUNC(_ISN_RegisterForRemoteNotifications);
	DECL_USER_FUNC(_ISN_RequestNotificationSettings);
	DECL_USER_FUNC(_ISN_SaveToCameraRoll);
	DECL_USER_FUNC(_ISN_GetVideoPathFromAlbum);
	DECL_USER_FUNC(_ISN_PickImage);
	DECL_USER_FUNC(_ISN_InitCameraAPI);
	DECL_USER_FUNC(_ISN_InitMediaController);
	DECL_USER_FUNC(_ISN_SetRepeatMode);
	DECL_USER_FUNC(_ISN_SetShuffleMode);
	DECL_USER_FUNC(_ISN_Play);
	DECL_USER_FUNC(_ISN_Pause);
	DECL_USER_FUNC(_ISN_SkipToNextItem);
	DECL_USER_FUNC(_ISN_SkipToBeginning);
	DECL_USER_FUNC(_ISN_SkipToPreviousItem);
	DECL_USER_FUNC(_ISN_ShowMediaPicker);
	DECL_USER_FUNC(_ISN_SetCollection);
	DECL_USER_FUNC(_ISN_ShowDP);
	DECL_USER_FUNC(_ISN_checkUrl);
	DECL_USER_FUNC(_ISN_openUrl);
	DECL_USER_FUNC(_ISN_GetIFA);
	DECL_USER_FUNC(_ISN_RetrieveLocalReceipt);
	DECL_USER_FUNC(_ISN_ReceiptRefreshRequest);
	DECL_USER_FUNC(_ISN_RetriveDeviceData);
	DECL_USER_FUNC(_ISN_StreamVideo);
	DECL_USER_FUNC(_ISN_OpenYouTubeVideo);
	DECL_USER_FUNC(_ISN_ShowRateUsPopUp);
	DECL_USER_FUNC(_ISN_ShowDialog);
	DECL_USER_FUNC(_ISN_ShowMessage);
	DECL_USER_FUNC(_ISN_DismissCurrentAlert);
	DECL_USER_FUNC(_ISN_TwPost);
	DECL_USER_FUNC(_ISN_FbPost);
	DECL_USER_FUNC(_ISN_MediaShare);
	DECL_USER_FUNC(_ISN_SendMail);
	DECL_USER_FUNC(_ISN_InstaShare);
	DECL_USER_FUNC(_ISN_WP_ShareText);
	DECL_USER_FUNC(_ISN_WP_ShareMedia);
	DECL_USER_FUNC(_IADCreateBannerAd);
	DECL_USER_FUNC(_IADCreateBannerAdPos);
	DECL_USER_FUNC(_IADShowAd);
	DECL_USER_FUNC(_IADHideAd);
	DECL_USER_FUNC(_IADDestroyBanner);
	DECL_USER_FUNC(_IADStartInterstitialAd);
	DECL_USER_FUNC(_IADLoadInterstitialAd);
	DECL_USER_FUNC(_IADShowInterstitialAd);
	DECL_USER_FUNC(_initCloud);
	DECL_USER_FUNC(_setString);
	DECL_USER_FUNC(_setDouble);
	DECL_USER_FUNC(_setData);
	DECL_USER_FUNC(_requestDataForKey);
	DECL_USER_FUNC(_MSP_InstaShare);
	DECL_USER_FUNC(_MSP_TwPost);
	DECL_USER_FUNC(_MSP_FbPost);
	DECL_USER_FUNC(_MSP_MediaShare);
	DECL_USER_FUNC(_MSP_SendMail);
	DECL_USER_FUNC(_twitterInit);
	DECL_USER_FUNC(_twitterLoadUserData);
	DECL_USER_FUNC(_twitterAuthificateUser);
	DECL_USER_FUNC(_twitterPost);
	DECL_USER_FUNC(_twitterPostWithMedia);
	DECL_USER_FUNC(iosInit);
	DECL_USER_FUNC(iosLogin);
	DECL_USER_FUNC(iosLogout);
	DECL_USER_FUNC(iosSetShareDialogMode);
	DECL_USER_FUNC(iosFeedRequest);
	DECL_USER_FUNC(iosAppRequest);
	DECL_USER_FUNC(iosCreateGameGroup);
	DECL_USER_FUNC(iosJoinGameGroup);
	DECL_USER_FUNC(iosFBSettingsPublishInstall);
	DECL_USER_FUNC(iosFBSettingsActivateApp);
	DECL_USER_FUNC(iosFBAppEventsLogEvent);
	DECL_USER_FUNC(iosFBAppEventsLogPurchase);
	DECL_USER_FUNC(iosFBAppEventsSetLimitEventUsage);
	DECL_USER_FUNC(iosGetDeepLink);
}
DLL_EXPORT void RegisterMonoModules()
{
	...
	mono_aot_register_module(mono_aot_module_TouchScript_info);
	...
	REGISTER_USER_FUNC(AdToApp_start_platform);
	REGISTER_USER_FUNC(AdToApp_setUnityCallbackTargetName_platform);
	REGISTER_USER_FUNC(AdToApp_isInterstitialDisplayed_platform);
	REGISTER_USER_FUNC(AdToApp_hasInterstitial_platform);
	REGISTER_USER_FUNC(AdToApp_removeAllBanners_platform);
	REGISTER_USER_FUNC(AdToApp_showBannerAtPosition_platform);
	REGISTER_USER_FUNC(AdToApp_showBanner_platform);
	REGISTER_USER_FUNC(AdToApp_setBannerRefreshInterval_platform);
	REGISTER_USER_FUNC(AdToApp_setLogLevel_platform);
	REGISTER_USER_FUNC(AdToApp_showInterstitial_platform);
	REGISTER_USER_FUNC(AdToApp_loadNextBanner_platform);
	REGISTER_USER_FUNC(_ISNsubscribe);
	REGISTER_USER_FUNC(_ISN_RedirectToAppStoreRatingPage);
	REGISTER_USER_FUNC(_ISN_ShowPreloader);
	REGISTER_USER_FUNC(_ISN_HidePreloader);
	REGISTER_USER_FUNC(_ISN_SetApplicationBagesNumber);
	REGISTER_USER_FUNC(_ISN_GetLocale);
	REGISTER_USER_FUNC(_ISN_IsGuidedAccessEnabled);
	REGISTER_USER_FUNC(_ISN_RequestGuidedAccessSession);
	REGISTER_USER_FUNC(_initGameCenter);
	REGISTER_USER_FUNC(_showLeaderboard);
	REGISTER_USER_FUNC(_reportScore);
	REGISTER_USER_FUNC(_showLeaderboards);
	REGISTER_USER_FUNC(_ISN_loadLeaderboardInfo);
	REGISTER_USER_FUNC(_ISN_loadLeaderboardScore);
	REGISTER_USER_FUNC(_showAchievements);
	REGISTER_USER_FUNC(_resetAchievements);
	REGISTER_USER_FUNC(_submitAchievement);
	REGISTER_USER_FUNC(_ISN_issueLeaderboardChallenge);
	REGISTER_USER_FUNC(_ISN_issueLeaderboardChallengeWithFriendsPicker);
	REGISTER_USER_FUNC(_ISN_issueAchievementChallenge);
	REGISTER_USER_FUNC(_ISN_issueAchievementChallengeWithFriendsPicker);
	REGISTER_USER_FUNC(_ISN_RetrieveFriends);
	REGISTER_USER_FUNC(_ISN_loadGKPlayerData);
	REGISTER_USER_FUNC(_ISN_loadGKPlayerPhoto);
	REGISTER_USER_FUNC(_ISN_getSignature);
	REGISTER_USER_FUNC(_ISN_loadLeaderboardSetInfo);
	REGISTER_USER_FUNC(_ISN_loadLeaderboardsForSet);
	REGISTER_USER_FUNC(_ISN_ShowNotificationBanner);
	REGISTER_USER_FUNC(_ISN_GK_IsUnderage);
	REGISTER_USER_FUNC(_ISN_RTM_FindMatch);
	REGISTER_USER_FUNC(_ISN_RTM_FindMatchWithNativeUI);
	REGISTER_USER_FUNC(_ISN_RTM_SetPlayerGroup);
	REGISTER_USER_FUNC(_ISN_RTM_SetPlayerAttributes);
	REGISTER_USER_FUNC(ISN_RTM_StartMatchWithInviteID);
	REGISTER_USER_FUNC(ISN_RTM_CancelPendingInviteToPlayerWithId);
	REGISTER_USER_FUNC(ISN_RTM_CancelMatchSeartch);
	REGISTER_USER_FUNC(ISN_RTM_FinishMatchmaking);
	REGISTER_USER_FUNC(ISN_RTM_QueryActivity);
	REGISTER_USER_FUNC(ISN_RTM_QueryPlayerGroupActivity);
	REGISTER_USER_FUNC(ISN_RTM_StartBrowsingForNearbyPlayers);
	REGISTER_USER_FUNC(ISN_RTM_StopBrowsingForNearbyPlayers);
	REGISTER_USER_FUNC(ISN_RTM_Rematch);
	REGISTER_USER_FUNC(ISN_RTM_Disconnect);
	REGISTER_USER_FUNC(ISN_RTM_SendData);
	REGISTER_USER_FUNC(ISN_RTM_SendDataToAll);
	REGISTER_USER_FUNC(_ISN_TBM_LoadMatchesInfo);
	REGISTER_USER_FUNC(_ISN_TBM_LoadMatch);
	REGISTER_USER_FUNC(_ISN_TBM_FindMatch);
	REGISTER_USER_FUNC(_ISN_TBM_FindMatchWithNativeUI);
	REGISTER_USER_FUNC(_ISN_TBM_SaveCurrentTurn);
	REGISTER_USER_FUNC(_ISN_TBM_SetPlayerGroup);
	REGISTER_USER_FUNC(_ISN_TBM_SetPlayerAttributes);
	REGISTER_USER_FUNC(_ISN_TBM_EndTurn);
	REGISTER_USER_FUNC(_ISN_TBM_QuitInTurn);
	REGISTER_USER_FUNC(_ISN_TBM_QuitOutOfTurn);
	REGISTER_USER_FUNC(_ISN_TBM_UpdateParticipantOutcome);
	REGISTER_USER_FUNC(_ISN_TBM_EndMatch);
	REGISTER_USER_FUNC(_ISN_TBM_Rematch);
	REGISTER_USER_FUNC(_ISN_TBM_RemoveMatch);
	REGISTER_USER_FUNC(_loadStore);
	REGISTER_USER_FUNC(_restorePurchases);
	REGISTER_USER_FUNC(_buyProduct);
	REGISTER_USER_FUNC(_ISN_InAppSettingState);
	REGISTER_USER_FUNC(_verifyLastPurchase);
	REGISTER_USER_FUNC(_createProductView);
	REGISTER_USER_FUNC(_showProductView);
	REGISTER_USER_FUNC(_ISN_ScheduleNotification);
	REGISTER_USER_FUNC(_ISN_CancelNotifications);
	REGISTER_USER_FUNC(_ISN_RequestNotificationPermissions);
	REGISTER_USER_FUNC(_ISN_CancelNotificationById);
	REGISTER_USER_FUNC(_ISN_ApplicationIconBadgeNumber);
	REGISTER_USER_FUNC(_ISN_RegisterForRemoteNotifications);
	REGISTER_USER_FUNC(_ISN_RequestNotificationSettings);
	REGISTER_USER_FUNC(_ISN_SaveToCameraRoll);
	REGISTER_USER_FUNC(_ISN_GetVideoPathFromAlbum);
	REGISTER_USER_FUNC(_ISN_PickImage);
	REGISTER_USER_FUNC(_ISN_InitCameraAPI);
	REGISTER_USER_FUNC(_ISN_InitMediaController);
	REGISTER_USER_FUNC(_ISN_SetRepeatMode);
	REGISTER_USER_FUNC(_ISN_SetShuffleMode);
	REGISTER_USER_FUNC(_ISN_Play);
	REGISTER_USER_FUNC(_ISN_Pause);
	REGISTER_USER_FUNC(_ISN_SkipToNextItem);
	REGISTER_USER_FUNC(_ISN_SkipToBeginning);
	REGISTER_USER_FUNC(_ISN_SkipToPreviousItem);
	REGISTER_USER_FUNC(_ISN_ShowMediaPicker);
	REGISTER_USER_FUNC(_ISN_SetCollection);
	REGISTER_USER_FUNC(_ISN_ShowDP);
	REGISTER_USER_FUNC(_ISN_checkUrl);
	REGISTER_USER_FUNC(_ISN_openUrl);
	REGISTER_USER_FUNC(_ISN_GetIFA);
	REGISTER_USER_FUNC(_ISN_RetrieveLocalReceipt);
	REGISTER_USER_FUNC(_ISN_ReceiptRefreshRequest);
	REGISTER_USER_FUNC(_ISN_RetriveDeviceData);
	REGISTER_USER_FUNC(_ISN_StreamVideo);
	REGISTER_USER_FUNC(_ISN_OpenYouTubeVideo);
	REGISTER_USER_FUNC(_ISN_ShowRateUsPopUp);
	REGISTER_USER_FUNC(_ISN_ShowDialog);
	REGISTER_USER_FUNC(_ISN_ShowMessage);
	REGISTER_USER_FUNC(_ISN_DismissCurrentAlert);
	REGISTER_USER_FUNC(_ISN_TwPost);
	REGISTER_USER_FUNC(_ISN_FbPost);
	REGISTER_USER_FUNC(_ISN_MediaShare);
	REGISTER_USER_FUNC(_ISN_SendMail);
	REGISTER_USER_FUNC(_ISN_InstaShare);
	REGISTER_USER_FUNC(_ISN_WP_ShareText);
	REGISTER_USER_FUNC(_ISN_WP_ShareMedia);
	REGISTER_USER_FUNC(_IADCreateBannerAd);
	REGISTER_USER_FUNC(_IADCreateBannerAdPos);
	REGISTER_USER_FUNC(_IADShowAd);
	REGISTER_USER_FUNC(_IADHideAd);
	REGISTER_USER_FUNC(_IADDestroyBanner);
	REGISTER_USER_FUNC(_IADStartInterstitialAd);
	REGISTER_USER_FUNC(_IADLoadInterstitialAd);
	REGISTER_USER_FUNC(_IADShowInterstitialAd);
	REGISTER_USER_FUNC(_initCloud);
	REGISTER_USER_FUNC(_setString);
	REGISTER_USER_FUNC(_setDouble);
	REGISTER_USER_FUNC(_setData);
	REGISTER_USER_FUNC(_requestDataForKey);
	REGISTER_USER_FUNC(_MSP_InstaShare);
	REGISTER_USER_FUNC(_MSP_TwPost);
	REGISTER_USER_FUNC(_MSP_FbPost);
	REGISTER_USER_FUNC(_MSP_MediaShare);
	REGISTER_USER_FUNC(_MSP_SendMail);
	REGISTER_USER_FUNC(_twitterInit);
	REGISTER_USER_FUNC(_twitterLoadUserData);
	REGISTER_USER_FUNC(_twitterAuthificateUser);
	REGISTER_USER_FUNC(_twitterPost);
	REGISTER_USER_FUNC(_twitterPostWithMedia);
	REGISTER_USER_FUNC(iosInit);
	REGISTER_USER_FUNC(iosLogin);
	REGISTER_USER_FUNC(iosLogout);
	REGISTER_USER_FUNC(iosSetShareDialogMode);
	REGISTER_USER_FUNC(iosFeedRequest);
	REGISTER_USER_FUNC(iosAppRequest);
	REGISTER_USER_FUNC(iosCreateGameGroup);
	REGISTER_USER_FUNC(iosJoinGameGroup);
	REGISTER_USER_FUNC(iosFBSettingsPublishInstall);
	REGISTER_USER_FUNC(iosFBSettingsActivateApp);
	REGISTER_USER_FUNC(iosFBAppEventsLogEvent);
	REGISTER_USER_FUNC(iosFBAppEventsLogPurchase);
	REGISTER_USER_FUNC(iosFBAppEventsSetLimitEventUsage);
	REGISTER_USER_FUNC(iosGetDeepLink);
}
...
void RegisterAllStrippedInternalCalls ()
{
	...
	void Register_UnityEngine_Application_UnloadLevel ();
	Register_UnityEngine_Application_UnloadLevel ();
	...
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_get_enabled ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_get_enabled ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_set_enabled ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_set_enabled ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_get_initializeOnStartup ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_get_initializeOnStartup ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_set_initializeOnStartup ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_set_initializeOnStartup ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_get_testMode ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_get_testMode ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_set_testMode ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_set_testMode ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_get_testEventUrl ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_get_testEventUrl ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_set_testEventUrl ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_set_testEventUrl ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_get_testConfigUrl ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_get_testConfigUrl ();
	void Register_UnityEngine_Analytics_UnityAnalyticsManager_set_testConfigUrl ();
	Register_UnityEngine_Analytics_UnityAnalyticsManager_set_testConfigUrl ();
	...
	void Register_UnityEngine_VR_InputTracking_GetLocalPosition ();
	Register_UnityEngine_VR_InputTracking_GetLocalPosition ();
	void Register_UnityEngine_VR_InputTracking_GetLocalRotation ();
	Register_UnityEngine_VR_InputTracking_GetLocalRotation ();
