...
struct  X509Store_t1093  : public Object_t
{
	...
	X509Certificate2Collection_t1084 * ___list_2;
	...
	X509Store_t1107 * ___store_4;
};
struct X509Store_t1093_StaticFields{
	...
	Dictionary_2_t402 * ___U3CU3Ef__switchU24mapF_5;
};
